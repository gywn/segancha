...
double color::CIEDE2000(const LAB &lab1, const LAB &lab2) {
  ...
  const double deg360InRad = color::deg2Rad(360.0);
  const double deg180InRad = color::deg2Rad(180.0);
  ...
  /* Equation 15 */
  double T = 1.0 - (0.17 * cos(barhPrime - color::deg2Rad(30.0))) +
             (0.24 * cos(2.0 * barhPrime)) +
             (0.32 * cos((3.0 * barhPrime) + color::deg2Rad(6.0))) -
             (0.20 * cos((4.0 * barhPrime) - color::deg2Rad(63.0)));
  /* Equation 16 */
  double deltaTheta =
      color::deg2Rad(30.0) *
